    ...
    return (
      <div>
        <button
          type="button"
          disabled=""
          className="inline-flex w-auto cursor-pointer select-none appearance-none items-center justify-center space-x-2 rounded border  bg-blue-100 px-7 py-4 text-sm font-medium text-white transition hover:border-blue-800 hover:bg-blue-800 focus:border-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:pointer-events-none disabled:opacity-75"
        >
          <svg className="h-12 w-8 animate-spin" viewBox="3 3 18 18">
            <path
          ...
          <span className="text-slate-800 text-2xl">Loading...</span>
        </button>
      </div>
    );
};
