        ...
        <div className="container p-4 mx-auto space-y-16 sm:p-10">
          <div className="space-y-4 flex flex-col items-center">
            ...
            <p className="max-w-2xl dark:text-gray-400">
              A very sensible and responsible world-class guide team dedicated
              and determined to reach your charming place and to make ensure
              your enjoyment in the whole journey.
            </p>
          </div>
          <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-3">
            <div className="hover:translate-y-4 border-1 border  rounded shadow-lg flex items-center bg-gray-200 text-gray-700">
              <img
                alt=""
                className="object-cover h-56 mx-auto  bg-center rounded-sm dark:bg-gray-500"
                src="https://source.unsplash.com/240x320/?portrait?0"
              />
              <div className="flex flex-col items-center mx-2">
                <h4 className="text-xl font-semibold">Leroy Jenkins</h4>
                <p className="text-sm dark:text-gray-400">
                  Expert in Tourism and manament
                </p>
